...
The following is a brief list of some features of MUME.

### MAP
The command `map` shows an overview of the area of Arda in MUME. The command `map darkness` will show the area Sauron is affecting with his darkness.

### WAR, WARLORDS
`view war` and `view warlords` can be used to view the results of the war between the free folk and the forces of the Red Eye. A player of the free folk killing another of the free folk is possible, but can lead to very serious results.
...
### BUTCHER/FISH/COOK
Butchering is a way to use a knife to recover useful items from the corpse of a game animal you have killed: meat, a pelt or fur you can sell… Butchering, and fishing with a fishing pole, are ways to produce food while you are out in the wilderness.

### MEND
Items that have become worn such as a dented piece of armor can be taken to an appropriate shopkeeper and fixed using the `mend` command. It is much cheaper to buy a used piece of equipment and mend it than to buy a brand new piece of equipment.
