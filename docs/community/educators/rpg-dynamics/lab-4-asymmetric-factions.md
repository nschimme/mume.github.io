---
title: "RPG Dynamics Lab 4: Faction Friction & Asymmetric World Design | Educator Portal"
description: Complete 45-minute Game Design lab analyzing how mechanical asymmetry (Free Peoples vs. Sauron's forces, dark/light vision, alignment sanctuaries) drives PvP engagement in MUME.
---

<div class="page-banner">
  <img class="banner-img" src="/assets/images/doors-of-durin@2x.png" alt="Doors of Durin - MUME Faction Asymmetry" />
</div>
...
```mermaid
graph LR
    A["🌲 Free Peoples Faction<br>(Humans, Elves, Dwarves)"] -->|Daytime Advantage| B["☀️ Daylight Vision & Town Sanctuaries"]
    C["🌋 Sauron's Forces Faction<br>(Orcs, Trolls, Dark Men)"] -->|Nighttime Advantage| D["🌙 Night Vision & Sunlight Regeneration Loss"]
    B <-->|Persistent World Tension| D
```
