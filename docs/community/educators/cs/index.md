...
* **Lab 2 (45 min):** [Regular Expressions & Pattern Capture Groups](/community/educators/cs/lab-2-regex)
* **Lab 3 (45 min):** [Event-Driven Triggers & Finite State Machines](/community/educators/cs/lab-3-parsing)
...
| **Day 3** | **Event-Driven Architecture:** Connect RegEx capture groups to conditional execution scripts and visual prompt alerts. | Mudlet Lua event trigger plugin. |
| **Day 4** | **Finite State Automata:** Model combat, flee, and recovery loops using state transition tables and enum variables. | FSM State Machine script. |
| **Day 5** | **Capstone Project & Code Review:** Combine aliases, regex, and state machines into an automated Middle-earth Assistant. | Submitted script & peer code review. |
