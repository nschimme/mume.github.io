...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /community/educators/cs/
    - theme: alt
      text: 15-Min Setup Guide ⏱️
      link: /community/educators/classroom-setup
    - theme: alt
...
features:
  - title: "Chromebook & Web-Ready"
    details: "Runs directly in any modern browser via HTTPS and WebSockets. Seamlessly bypasses legacy MUD port 4242 firewall blocks with zero software downloads or IT overhead."
    icon: 💻
