---
title: "Humanities Lab 4: Collaborative Storytelling & Player Lore | Educator Portal"
description: Complete 45-minute Literature lab analyzing transcripts comparing authored, scripted NPC interactions with unscripted, real-time player roleplay and community lore.
---

<div class="page-banner">
  <img class="banner-img" src="/assets/images/fellowship_bw@2x.jpg" alt="Collaborative Storytelling in Middle-earth" />
</div>
...
```mermaid
graph TD
    A["📜 Authored Narrative Layer<br>(Developer Coded NPCs, Quests, Lore)"] --> C["🎭 Collaborative Storytelling Stream"]
    B["⚔️ Emergent Narrative Layer<br>(Unscripted Player Battles, Alliances, Tales)"] --> C
```
...
> <span class="command">ask ermin hunt</span>
<span class="say">Ermin the Ranger says 'Troll tracks have been spotted near the Black Hills.'</span>
<span class="say">Ermin the Ranger says 'Take this torch and watch the eastern passes at nightfall.'</span>
</pre>
</MumeSession>
...
<MumeSession>
<pre class="session" v-pre>
<span class="say">An Elven Scout arrives from the east, riding a white horse.</span>
> <span class="command">say Greetings, stranger of the Westron Road.</span>
<span class="say">You say 'Greetings, stranger of the Westron Road.'</span>
<span class="say">The Elven Scout bows deeply and says 'The shadow falls long over the Greenway. Will you stand with us at the Last Bridge?'</span>
</pre>
</MumeSession>
