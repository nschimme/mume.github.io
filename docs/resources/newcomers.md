...
Welcome to MUME! What you find on this page is an extension of the documentation available in-game. This page features several tutorials to aide you, our newest player, in navigating MUME.
...
There are several tutorials available. You can watch the YouTube tutorial series below.

Quick tips for watching the videos:
* Watch in fullscreen and high quality; otherwise the text is hard to see
* Confirm that annotations are enabled
