...
<p><strong>Do you side with the Free Peoples of the West?</strong></p>
<p>
Choose from Men, Elves, Half-elves, Hobbits, and Dwarves to defend the Free People.
</p>
</div>
</div>
</section>
...
<p><strong>Will you be a cunning and wicked villain?</strong></p>
<p>
...
<ul>
  <li>Warrior</li>
  <li>Stealthy scout</li>
  <li>Master of magical arts</li>
  <li>Healer</li>
</ul>
<p>Do you choose to be a ranger? A warmage? Endless possibilities are yours.</p>
</div>
</div>
</section>
...
<p>Visit an astonishing number of beautifully described locations:</p>
<ul>
  <li>Enjoy an ale at Bree, wander the Shire, and explore Fornost</li>
  <li>Seek Elrond in Rivendell and brave the Trollshaws</li>
  <li>Get lost in Goblin-town, nestled deep in the Misty Mountains</li>
  <li>Pass through the Orc-infested Mines of Moria and enter fair Lothlórien</li>
  <li>Meet Ents in Fangorn Forest and explore Isengard or the Gap of Rohan</li>
  <li>Discover the growing shadow in Dol Guldur and Mirkwood</li>
</ul>
<a href="./about/features" class="read-more">Learn More</a>
</div>
</div>
</section>
...
<p>There are older and fouler things than Orcs in the deep places of the world.</p>
<ul>
  <li>Slay a Balrog by gathering a company of dwarves to take on Durin’s Bane</li>
  <li>Release the Wightlord of the Barrow-downs from his curse</li>
  <li>Brave a Kraken by taking on the Watcher in the Water</li>
  <li>Outsmart Bill, Bert, and Tom to avoid becoming lunch</li>
</ul>
</div>
</div>
</section>
...
<section class="community-section">
<h2>Acquire Legendary Artefacts</h2>
<div class="card">
<div>
<p>Find forgotten relics of awesome power from the First and Second Age.</p>
<ul>
  <li>Wield Glamdring the Foe-hammer, Orcrist the Goblin-cleaver, and Sting</li>
  <li>Stab your foe with a Morgul-blade and watch them turn into a Wraith</li>
  <li>Use the Palantír of Amon Sûl to hunt down fresh meat</li>
  <li>Wear a shirt of shining mail, wrought from the finest mithril</li>
</ul>
</div>
</div>
</section>
...
<section class="community-section">
<h2>Hundreds of Achievements and Quests</h2>
<div class="card">
<div>
<p>Can you free Arda from all the sorrows that weigh upon it?</p>
<ul>
  <li>Pacify unsavory characters like Bill Ferny and the corrupt Chief of Tharbad</li>
  <li>Befriend a lonely giant and learn how to bake delectable bannocks to feed the hungry</li>
  <li>Free a Silvan elf from certain death in the depths of Mirkwood Forest</li>
  <li>Follow in Celebrimbor's footsteps and forge Rings of Power at the ruins of Ost-in-Edhil</li>
</ul>
</div>
</div>
</section>
...
<section class="community-section">
<h2>Become the #1 Ranked Warlord</h2>
<div class="card">
...
<p>Find adulation and glory by outwitting your opponents in a highly competitive world PvP.</p>
<ul>
  <li>Track your opponent from afar to strike at the perfect time</li>
  <li>Pick locks or block doors to trap your foes</li>
  <li>Mix foetid poisons to envenom your foes</li>
</ul>
</div>
</div>
</section>
...
<section class="community-section">
<h2>Gamble it all to win</h2>
<div class="card">
<div>
<p>Experience the insane PvP rush as your character takes part in the war.</p>
<ul>
  <li>Strip your opponents corpse clean by taking their gear as your own</li>
