...
<img src="./assets/images/doors-of-durin.png" alt="Speak, friend, and enter" class="banner-img" style="max-width: 300px;">
</div>
...
MUME was originally intended to be played using telnet or a MUD client. There was no visual map to aid you and players would map out the world in their head or draw it down on paper.
...
For alternatives, check out our [open source projects](./community/opensource). You may also find legacy clients at our [mirror](https://mume.org/download/clients/){target="_self" rel="external"}.
